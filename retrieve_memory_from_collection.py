...
def retrieve_memories(query_text: str, keyword_filter: Optional[str] = None, limit: int = SearchConstants.DEFAULT_SEARCH_LIMIT) -> List[str]:
    """
...
def search_memories_with_filter(query_text: str, keyword_filter: str, limit: int = SearchConstants.DEFAULT_SEARCH_LIMIT) -> List[str]:
    """
    ...
    if keyword_filter:
        ...
        filtered_memories = [
            ...
            if keyword_filter.lower() in memory.lower()
        ]
