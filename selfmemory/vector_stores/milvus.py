...
from selfmemory.configs.vector_stores.milvus import MetricType
...
class MilvusDB(VectorStoreBase):
    def __init__(
        ...
        Args:
            ...
            collection_name (str): Name of the collection (defaults to selfmemory).
    ...
    def insert(self, ids, vectors, payloads, **kwargs: dict[str, any] | None):
        ...
        for idx, embedding, metadata in zip(ids, vectors, payloads, strict=False):
            ...
            self.client.insert(
                collection_name=self.collection_name, data=data, **kwargs
            )
