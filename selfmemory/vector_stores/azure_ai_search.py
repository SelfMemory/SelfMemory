...
class AzureAISearch(VectorStoreBase):
    def __init__(
        ...
        self.search_client._client._config.user_agent_policy.add_user_agent(
            "selfmemory"
        )
        self.index_client._client._config.user_agent_policy.add_user_agent("selfmemory")
    ...
    def reset(self):
        ...
        try:
            ...
            self.index_client._client._config.user_agent_policy.add_user_agent(
                "selfmemory"
            )
