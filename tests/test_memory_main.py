...
class TestMemoryInitialization:
    ...
    def test_memory_init_with_default_config(self, mock_ollama_embedding, mock_qdrant_vector_store):
        """
        TEST EXPLANATION:
        ================
    ...
    def test_memory_init_with_custom_config(self, mock_ollama_embedding, mock_qdrant_vector_store):
        """
        TEST EXPLANATION:
        ================
...
class TestMemoryAdd:
    ...
    def test_add_memory_success(self, mock_memory_instance, mock_embedding_response):
        ...
        mock_memory_instance.embedding_provider.embed.assert_called_once_with(test_content)
        ...
        vectors, payloads, ids = call_args[1]['vectors'], call_args[1]['payloads'], call_args[1]['ids']
    ...
    def test_add_memory_with_metadata(self, mock_memory_instance, mock_embedding_response):
        """
        TEST EXPLANATION:
        ================
    ...
    def test_add_memory_embedding_failure(self, mock_memory_instance):
        ...
        mock_memory_instance.embedding_provider.embed.side_effect = Exception("Embedding service unavailable")
...
class TestMemorySearch:
    ...
    def test_search_with_query(self, mock_memory_instance, mock_embedding_response, create_mock_point):
        """
        TEST EXPLANATION:
        ================
    ...
    def test_search_empty_query_returns_all(self, mock_memory_instance, create_mock_point):
        """
        TEST EXPLANATION:
        ================
...
class TestMemoryGetAll:
    ...
    def test_get_all_memories(self, mock_memory_instance, create_mock_point):
        ...
        mock_memory_instance.vector_store.list.assert_called_once_with(filters=None, limit=50)
...
class TestMemoryDelete:
    ...
    def test_delete_memory_exception(self, mock_memory_instance):
        ...
        mock_memory_instance.vector_store.delete.side_effect = Exception("Database connection failed")
...
class TestMemoryUtilityMethods:
    ...
    def test_health_check_failure(self, mock_memory_instance):
        ...
        mock_memory_instance.vector_store.count.side_effect = Exception("Vector store unavailable")
        
        # Also make embedding provider fail if it has health_check
        if hasattr(mock_memory_instance.embedding_provider, 'health_check'):
            mock_memory_instance.embedding_provider.health_check.side_effect = Exception("Embedding provider unavailable")
