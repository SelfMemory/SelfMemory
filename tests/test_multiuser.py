...
def test_user_management():
    ...
    for user_id in valid_users:
        ...
        try:
            collection_name = (
                user_manager.get_collection_name(user_id) if is_valid else "N/A"
            )
        except:
            collection_name = "N/A"
        print(
            f"User: {user_id:26} | Valid: {is_valid:5} | Collection: {collection_name}"
        )
...
def test_collection_creation():
    ...
    try:
        ...
        print("❌ Should have failed for invalid_user")
    except Exception as e:
...
def main():
    ...
    try:
        ...
        print(
            "npx install-mcp https://inmemory.tailb75d54.ts.net/{user_id}/sse --client claude"
        )
